public class ejercicio3 {
	...
	//	Ordenador PcBase = new Ordenador("Intel core", "MSI", 16, "GTX 3090", 800);
		...
		ordenadorcasa.motherboardName = motherboardName;
		ordenadorcasa.ramGB = ramGB;
		ordenadorcasa.graphiccardName = graphiccardName;
		ordenadorcasa.poweSupplyWs = poweSupplyWs;
...
class Ordenador {
 ...
 /*	public Ordenador(String cpuName, String motherboardName, int ramGB, String graphiccardName, int poweSupplyWs) {
    ...
    public String toString() {
 	   String T = "Ordenador [CPU=" + this.cpuName 
	   + ", Motherboard=" + this.motherboardName 
	   + ", RAM=" + this.ramGB 
	   + "GB, Graphic Card=" + this.graphiccardName 
	   + ", Power Supply=" + this.poweSupplyWs + "W]";
		return T;
	}
}
