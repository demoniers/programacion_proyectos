...
public class MAIN {
    public static void main(String[] args) throws Exception {
        ...
        Contenido content2 = new Contenido(001,"Java 2", "Este es un ejercicio de java intermidio.");
        Contenido content3 = new Contenido(001,"Java 3", "Este es un ejercicio de java complejo.");
